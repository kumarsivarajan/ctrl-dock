...
?>
		...
		<td class=ezqreportdata style="text-align:center">&nbsp;<? echo $i; ?></font></td>		
		<td class=ezqreportdata style="text-align:center">&nbsp;<? echo date("d M Y",$row[0]); ?></font></td>		
		<td class=ezqreportdata>&nbsp;<? echo $row[1];if($row[7]==1){echo " * ";}?></font></td>
		<td class=ezqreportdata style="text-align:center">&nbsp;<? echo $row[2]; ?></font></td>
		<td class=ezqreportdata>&nbsp;<? echo $row[3]; ?></font></td>
		<td class=ezqreportdata style="text-align:center">&nbsp;<? echo $row[4]; ?></font></td>
		<td class=ezqreportdata style="text-align:right"><?echo $CURRENCY;?> <? echo $row[5]; ?>&nbsp;</font></td>
		<td class=ezqreportdata style="text-align:right"><b><?echo $CURRENCY;?> <? echo $row[6]; ?>&nbsp;</b></font></td>
		
<?		if($expense_edit==1){?>
			<td class=ezqreportdata style="text-align:center"><a href=expense_delete.php?entry_id=<?echo $row[8];?>&expense_id=<?echo $expense_id;?>><img src=images/delete.gif border=0></img></a></td>
<?		}	?>
...
<tr>
		<td colspan=8 class=ezqreportdata style="text-align:left">&nbsp;* Amount is restricted to the authorization eligible for the staff.</td>
</tr>
</table>
<br>
<?
...
?>
			...
			<td class=ezqreportdata>&nbsp;<? echo "$row[2] $row[3]";?></font></td>
			<td class=ezqreportdata style="text-align:left">&nbsp;<? echo $row[4]; ?></font></td>		
			</tr>
<?
		$i++;
		}
