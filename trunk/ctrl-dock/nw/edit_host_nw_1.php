...
$sql = "select count,timeout,enabled,alarm_threshold from hosts_nw where host_id='$host_id'";
...
<tr>
	<td class='tdformlabel'><b>No. of Pings</font></b></td>
	<td align=right><input name="count" size="10" class='forminputtext' value='<?echo $count;?>'></td>
</tr>
<tr>
	<td class='tdformlabel'><b>Ping Timeout (in secs)</font></b></td>
