...
<table border=1 width=100% cellspacing=0 cellpadding=2 style="border-collapse: collapse" bordercolor="#E5E5E5" bgcolor=#F5F5F5>
<tr><td class=reportheader style='text-align:left'><b>&nbsp;Attachments</font></b></td></tr>
<tr><td>
<?
$redirecturl="rca_edit_1.php?activity_id=$activity_id";
?>
...
<table border=0 width=100% cellspacing=0 cellpadding=2 style="border-collapse: collapse" bordercolor="#E5E5E5">
<?
	...
	for($ctr=0;$ctr<$filecount;$ctr++){
				...
				echo "<td class=reportdata style='text-align:center;'><a href='rca_del_attachment.php?activity_id=$activity_id&filename=$file'><img src=../admin/images/delete.gif border=0></a></td>";
				echo "</tr>";
	}
