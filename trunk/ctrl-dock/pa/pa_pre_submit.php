...
?>
<center>
<form method=POST action='pa_submit.php?activity_id=<?=$activity_id;?>'>
<table border=1 width=100% cellspacing=0 cellpadding=4 style="border-collapse: collapse" bordercolor="#E5E5E5" bgcolor=#FFCC00>
<tr>
	<td align=center>
		<input type=submit value="SUBMIT THE PLANNED ACTIVITY FOR APPROVAL" name="Submit" class=forminputtext>
