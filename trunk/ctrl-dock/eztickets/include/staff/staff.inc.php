...
if($staff && $_REQUEST['a']!='new'){
    ...
    $rep['new_tkt_not']=isset($rep['new_tkt_not'])?$rep['new_tkt_not']:1;
    $rep['close_tkt_not']=isset($rep['close_tkt_not'])?$rep['close_tkt_not']:1;
...
<form action="admin.php" method="post">
 ...
 <tr><td>
    <table width="100%" border="0" cellspacing=0 cellpadding=2 class="tform">
        ...
        <tr><th>New Ticket Notification</th>
            <td class="mainTableAlt">
					<input type="radio" name="new_tkt_not"  value="1" <?=$rep['new_tkt_not']?'checked':''?> /><b>Enabled</b>
					<input type="radio" name="new_tkt_not"  value="0" <?=!$rep['new_tkt_not']?'checked':''?> /><b>Disabled</b>
			</td>
		</tr>
		<tr><th>Close Ticket Notification</th>
            <td class="mainTableAlt">
					<input type="radio" name="close_tkt_not"  value="1" <?=$rep['close_tkt_not']?'checked':''?> /><b>Enabled</b>
					<input type="radio" name="close_tkt_not"  value="0" <?=!$rep['close_tkt_not']?'checked':''?> /><b>Disabled</b>
			</td>
		</tr>
