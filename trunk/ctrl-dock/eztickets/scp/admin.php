...
switch($thistab){
    ...
    case 'topics':
		...
		$nav->addSubMenu(array('desc'=>'Incidents','href'=>'admin.php?t=topics&tt=fi','iconclass'=>'helpTopics'));
		$nav->addSubMenu(array('desc'=>'Problems','href'=>'admin.php?t=topics&tt=p','iconclass'=>'helpTopics'));
        $nav->addSubMenu(array('desc'=>'Service Requests','href'=>'admin.php?t=topics&tt=sr','iconclass'=>'helpTopics'));
		$nav->addSubMenu(array('desc'=>'Change Requests','href'=>'admin.php?t=topics&tt=cr','iconclass'=>'helpTopics'));			
        $nav->addSubMenu(array('desc'=>'Add New','href'=>'admin.php?t=topics&a=new','iconclass'=>'newHelpTopic'));
		...
		$new_url="topic.inc.php";
		$list_url="helptopics_fi.php";
		if($_REQUEST['tt']=="sr"){$list_url="helptopics_sr.php";}
		if($_REQUEST['tt']=="cr"){$list_url="helptopics_cr.php";}
		if($_REQUEST['tt']=="fi"){$list_url="helptopics_fi.php";}
		if($_REQUEST['tt']=="p"){$list_url="helptopics_p.php";}				
        $page=($topic or ($_REQUEST['a']=='new' && !$topicID))?$new_url:$list_url;
        break;
    ...
    case 'staff':
        ...
        $nav->addSubMenu(array('desc'=>'Users','href'=>'admin.php?t=staff','iconclass'=>'users'));
        $nav->addSubMenu(array('desc'=>'Add New User','href'=>'admin.php?t=staff&a=new','iconclass'=>'newuser'));
        $nav->addSubMenu(array('desc'=>'Groups','href'=>'admin.php?t=groups','iconclass'=>'groups'));
