...
$sql="SELECT a.host_id,a.hostname,b.count,b.timeout,b.alarm_threshold FROM hosts_master a,hosts_nw b WHERE a.host_id=b.host_id AND a.status='1' AND b.enabled='1' ORDER BY a.hostname";
$result = mysql_query($sql);
