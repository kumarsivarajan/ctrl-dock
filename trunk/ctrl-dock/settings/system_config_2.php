...
$menu_bgcolor       =$_REQUEST["menu_bgcolor"];
...
$sql.= " service_dash='$service_dash', service_ezasset='$service_ezasset', service_ezticket='$service_ezticket', service_network='$service_network', snmp='$snmp', terminal='$terminal', terminalport='$terminalport',menu_bgcolor='$menu_bgcolor'";
