...
return $div_clean;
  ...
  echo "  <td class=\"contenthead\" colspan=\"3\">";
  echo "ADD PACKAGE TO SOFTWARE REGISTER&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href=software_register.php>Software Register</a></td>\n";
  echo "</tr>\n";
  echo "<tr>\n";
  ...
  if ($myrow = mysql_fetch_array($result)){
    ...
    do {
      ...
      echo "  <td align=left>" . $myrow["count(software_name)"] . "</td>\n";
      echo "  <td align=left>&nbsp;&nbsp;" . $myrow["software_name"] . "</td>\n";
      echo "<td>";
