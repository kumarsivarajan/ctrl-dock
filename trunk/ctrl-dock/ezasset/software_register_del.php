...
echo "<p class=\"contenthead\"><font style='font-size: 14px;font-weight: bold;font-family: Arial;color: #FF6600;text-align: center;'>Remove from Software License Register</p>";
