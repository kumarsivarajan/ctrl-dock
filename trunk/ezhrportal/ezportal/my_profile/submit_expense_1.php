...
<form method=POST action=submit_expense_2.php>
...
<tr>	
	<td bgcolor=#BBBBBB colspan=2 align=center><input type="submit" value="Submit Expense Report" class='forminputbutton' style='width:400px'/>&nbsp;</td>	
</tr>
