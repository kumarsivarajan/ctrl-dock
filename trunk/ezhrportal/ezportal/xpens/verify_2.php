...
<?
	...
	$sql = "update expense_report set status='PENDING CLEARANCE' where expense_id='$expense_id'";
	...
	$sql = "insert into expense_log (expense_id,action,action_by,action_date,action_comments) values ('$expense_id','$action','$username','$timestamp','$action_comments')";
        ...
        $body.="Your expense report has been $action by the Finance Department<br><br>";
