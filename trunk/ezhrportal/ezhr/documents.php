...
$conf_chroot="../data/hrms_attachments/".$_SESSION['account']."/";

if (file_exists($conf_chroot)) {        
    } else { mkdir($conf_chroot, 0755);   }  

	
$conf_images    = 'images/documents/'; // Directory that contains the FileManager images
...
function make_directory()
{
	...
	if (isset($_POST['dir']) && $_POST['dir'] != '') {		
		...
		echo "<html><head><LINK href=\"include/css/fm.css\" rel=stylesheet></head><body>\n".
...
function draw_files()
{
	...
	echo "<tr><td height=100% valign=bottom align=left colspan=8><p align=center><br>\n".
		 ...
		 "<input class=button type=\"button\" value=\"Upload\" onClick=\"window.open('{$_SERVER['PHP_SELF']}?event=upload&path=$current_path','win_upload','width=800,height=500,fullscreen=no,scrollbars=no,resizable=no,status=no,toolbar=no,menubar=no,location=no')\">".
		 "<br>&nbsp;</p></td></tr>\n".
		 "</form>\n".
	 	 "</table>\n".
		 "</div>\n".
...
<html>
<head>
<LINK href="include/css/fm.css" rel=stylesheet>
...
?>
<tr>
	<td height=35 align=left valign=middle bgcolor=#666666>	
	&nbsp;&nbsp;
	<font face=Arial size=2 color=white><b>
	Documents >  
	<?echo $_SESSION['account'];?></b>
	&nbsp;&nbsp;&nbsp;&nbsp;
	<? echo $rep_base ?><? echo $current_path; ?>
	</td>
	<td height=35 align=right valign=middle bgcolor=#666666>	
		<a href="hrms/user_home.php?account=<?=$_SESSION['account'];?>"><font face="Arial" color="#FFFFFF" size="1"><b>BACK</b></font></a>
		&nbsp;
	</td>
</tr>
<?
