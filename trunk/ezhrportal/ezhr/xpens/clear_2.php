...
<?
	...
	$sql = "update expense_report set status='CLEARED' where expense_id='$expense_id'";
	...
	$sql = "insert into expense_log (expense_id,action,action_by,action_date,action_comments) values ('$expense_id','$action','$username','$timestamp','$action_comments')";
    $result = mysql_query($sql);
        ...
        $body.="Your expense report has been $action by the Finance Department with the following comments <br><br>";
...
?>
<meta http-equiv="Refresh" content="0; URL=clearance.php">
