...
document.write('<tr><td style="cursor:pointer" onclick="csubm()"><img src="../images/calarrowleft.gif"></td><td colspan=5 id="mns" align="center" style="font:bold 13px Arial;text-align:center"></td><td align="right" style="cursor:pointer" onclick="caddm()"><img src="../images/calarrowright.gif"></td></tr>');
