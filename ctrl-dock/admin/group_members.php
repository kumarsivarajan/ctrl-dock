...
?>
	...
	<tr>
		<td align=center>
			...
			<?php
			    $sql = "select username,first_name,last_name from user_master where account_status='Active' and username not in (select username from user_group where group_id='$id') order by username";	
...
<?
	$sql = "select a.username,b.first_name,b.last_name from user_group a, user_master b where a.group_id='$id' and a.username=b.username and b.account_status='Active' order by username";	
	$result = mysql_query($sql);	  
