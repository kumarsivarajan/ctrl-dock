...
<div id="loginBox">
    ...
    <table border=0 align="center">
        <tr><td width=100px align="right"><font size=2><b>Username</b></td><td><input type="text" name="username" id="name" /></td></tr>
        <tr><td align="right"><font size=2><b>Password</b></td><td><input type="password" name="passwd" id="pass" /></td></tr>
