...
class Staff {
	...
	function new_tkt_not(){
        return ($this->udata['new_tkt_not'])?true:false;
    }

	function close_tkt_not(){
        return ($this->udata['close_tkt_not'])?true:false;
    }
    ...
    function save($id,$vars,&$errors) {
        ...
        if(!$errors){
            ...
            $sql=' SET updated=NOW() '.
				 ...
				 ',new_tkt_not='.db_input($vars['new_tkt_not']).
				 ',close_tkt_not='.db_input($vars['close_tkt_not']).
