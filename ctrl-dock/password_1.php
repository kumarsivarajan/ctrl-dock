...
<body>
  <center>
	<form name=addform method="post" action="password_2.php">
    <p><b><font face="Arial" color="#CC0000" size="2">Change Password</font></b></p>
    <table border="1" cellpadding="5"  width="500" height="149" style="border-width:0px; border-collapse: collapse; " bordercolor="#FFFFFF" bgcolor=#DDDDDD id="table2">
      <tr>
