...
$query_array=array("headline"=>array("name"=>__("Installed Software"),
                   ...
                   "sql"=>"SELECT software_name, software_version, software_publisher, software_url, software_install_date, software_first_timestamp FROM software, system WHERE system_uuid = '".$_REQUEST["pc"]."' AND software_name NOT LIKE '%hotfix%' AND software_name NOT LIKE '%Service Pack%' AND software_name NOT REGEXP '[KB|Q][0-9]{6,}' AND software_uuid = system_uuid AND software_timestamp = system_timestamp GROUP BY software_name, software_version ",
                   "sort"=>"software_name",
                   "dir"=>"ASC",
