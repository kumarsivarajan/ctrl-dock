...
$query_array=array("headline"=>__("Statistic for Mozilla Thunderbird Versions"),
                   "sql"=>"
                           SELECT
                               ...
                               round( 100 / (
                                       ...
                                       WHERE
                                           software_name LIKE 'Mozilla Thunderbird%' AND
                                           software_name NOT LIKE 'Mozilla Thunderbird Extension%' AND
